...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row">
        <asp:ListView runat="server" ID="FilteredVenues" ItemType="SportSquareDTOs.VenueDTO" class="col-md-8">
            <LayoutTemplate>
                            ...
                            <div class="infoCol">
                                <div class="venueBlock">
                                    <div class="venueDetails">
                                        <div class="venueScore positive" title="" <%--style="background-color: #73CF42;"--%>><%--<%# Item.Score %>--%></div>
                                        <div class="venueName">
                                            <h2><span class="venueIndex"><%--<%#:Items %>--%></span>. <a href="" target="_blank"><%#: Item.Name %></a></h2>
                                        </div>
                                        <div class="venueMeta">
                                            <div class="venueAddressData">
                                                <%--<asp:ListView runat="server" ItemType="SportSquareDTOs.VenueTypeDTO" ID="VenueType">
                                                    <ItemTemplate>
                                                <div class="venueData"><span class="venueDataItem"><span class="categoryName">Bar</span></div>
                                                    </ItemTemplate>
                                                </asp:ListView>--%>
