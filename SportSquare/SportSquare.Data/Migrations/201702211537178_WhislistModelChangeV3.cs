namespace SportSquare.Data.Migrations
{
    ...
    public partial class WhislistModelChangeV3 : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        WebAddress = c.String(),
                        IsHidden = c.Boolean(nullable: false),
                        UserWishVenue_UserId = c.Guid(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.UserWishVenues", t => t.UserWishVenue_UserId)
                .Index(t => t.UserWishVenue_UserId);
        ...
        {
            DropForeignKey("dbo.Venues", "UserWishVenue_UserId", "dbo.UserWishVenues");
            DropForeignKey("dbo.UserWishVenues", "UserId", "dbo.Users");
            ...
            DropIndex("dbo.UserWishVenues", new[] { "UserId" });
            DropIndex("dbo.Venues", new[] { "UserWishVenue_UserId" });
