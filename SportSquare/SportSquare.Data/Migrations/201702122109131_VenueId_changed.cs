namespace SportSquare.Data.Migrations
{
    ...
    public partial class VenueId_changed : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        VenueType_VenueTypeId = c.Int(nullable: false),
                        Venue_VenueId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => new { t.VenueType_VenueTypeId, t.Venue_VenueId })
                .ForeignKey("dbo.VenueTypes", t => t.VenueType_VenueTypeId, cascadeDelete: true)
                .ForeignKey("dbo.Venues", t => t.Venue_VenueId, cascadeDelete: true)
                .Index(t => t.VenueType_VenueTypeId)
        ...
        public override void Down()
        {
            ...
            DropIndex("dbo.VenueTypeVenues", new[] { "Venue_VenueId" });
            DropIndex("dbo.VenueTypeVenues", new[] { "VenueType_VenueTypeId" });
